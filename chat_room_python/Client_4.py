...
class MyMainWindow(QMainWindow):
    ...
    def __init__(self, username="phuc"):
        super().__init__()
        ...
        self.server_socket.connect(("172.20.10.12", 1503))
        self.server_socket2.connect(("172.20.10.12", 1504))
    ...
    def loadUsers(self):
        ...
        for x in users:
            if x[0] != self.name:
                self.ui.list_user.addItems([x[0]])
